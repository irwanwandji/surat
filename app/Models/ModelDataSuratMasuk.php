...
class ModelDataSuratMasuk extends Model
{
    protected $table = "tb_suratmasuk";
    protected $column_order = array('id_surat', 'expedisi', 'jml_surat', 'tujuan_surat', 'asal_surat', 'diterima', 'jam_diterima', 'penerima', 'keterangan', 'tgl_kembali');
    protected $column_search = array('expedisi', 'tujuan_surat', 'asal_surat', 'penerima', 'keterangan');
    protected $order = array('id_surat' => 'ASC');
    protected $request;
    protected $db;
    protected $dt;
    ...
    // {
    //     if ($tglawal == '' && $tglakhir = '') {
    //         $tbl_storage = $this->db->table('', 'idpel=pelid', 'left');
    //     } else {
